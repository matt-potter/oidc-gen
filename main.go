...
// Copied from here, to allow a go-gettable binary for boostrapping clusters https://github.com/aws/amazon-eks-pod-identity-webhook/blob/master/hack/self-hosted/main.go
